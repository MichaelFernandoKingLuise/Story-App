  ...
  getTemplate() {
    return `
      <section class="container">
        <h1>Saved Stories | Story Locations</h1>
          ...
          <div class="modal-content">
            ...
            <div class="modal-details">
              ...
              <div class="modal-meta">
                ...
                <button class="bookmark-btn bookmarked btn btn-transparent" id="bookmark-btn">
                  <i class="fas fa-bookmark"></i> Remove Story
                </button>
              </div>
            </div>
          </div>
